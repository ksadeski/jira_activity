     ...
     AP.define('JiraActivity', {
         buildProjectTable: function(projects, selector) {
             ...
             function buildTableAndReturnTbody(hostElement) {
                 ...
                 projHeadRow.append("th").text("Assignee");
             ...
             row.append("td").append('span')
                 .classed({'project-name': true}) //not sure what this does
                 .append("a")
                 // make the name a link to the project
                 .attr('href', function(item) { return projectBaseUrl + item.key; }) //this links to project
                 // since we're in the iframe, we need to set _top
                 .attr('target', "_top")
                 .text(function(item) { return item.name; }); //this fills the name column
            ...
            //trying to print assignee names
             ...
             projBody.append("tr").text("Total Projects: " + rowCount);
         }
     });
 });